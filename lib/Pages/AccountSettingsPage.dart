...
final FocusNode nicknamefocusnode=FocusNode();
  ...
  Widget build(BuildContext context) {
          ...
          child: Column(
                ...
                child: Center(
                  child: Stack(
                    children: <Widget>[
                      ...
                      Icon(Icons.account_circle,size: 90.0,color: Colors.grey,):Material(
                        //new update
            ...
            clipBehavior: Clip.hardEdge
                      ...
                      IconButton(
                        ...
                        iconSize: 200,
                        icon: Icon(Icons.camera_alt,size: 40.0,color: Colors.grey.withOpacity(0.3)),),
              ...
              Column(
                children: <Widget>[
                  ...
                  Container(
                    child: Text(
                      "Profile name ",style: TextStyle(fontWeight: FontWeight.bold,fontStyle: FontStyle.italic,fontSize: 20),
                    ),
                  ),
    ...
    focusNode: nicknamefocusnode,
                  ...
                  Container(
                    child: Text(
                      "About me ",style: TextStyle(fontWeight: FontWeight.bold,fontStyle: FontStyle.italic,fontSize: 20),
                    ),
                  ),
              ...
              Padding(padding:EdgeInsets.only(left: 50.0,right: 50.0) ,child: RaisedButton(
                color: Colors.red,
